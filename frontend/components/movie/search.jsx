  ...
  render(){
    return(
        <div id='search-holder' className='column'>
          ...
          <div id='rp-align' className='s-button' onClick={() => this.props.search(this.state.search, this.state.rating, this.state.month,this.state.day,this.state.year)}>search</div>
        </div>
      </div>
    );
  }
